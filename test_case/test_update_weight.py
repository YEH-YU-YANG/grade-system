...
class TestUpdateWeights(unittest.TestCase):
    """
    Test suite for the update_weights method in the ScoreSystem class.
    ...
    Methods:
        ...
        test_valid_input: Tests the update_weights method with various valid input formats.
        test_invalid_input: Tests the update_weights method with various invalid input formats.
    """
    def setUp(self):
        """
        Method description:
